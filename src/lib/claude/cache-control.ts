 ...
 *   messages: addCacheControlToLast(messages)
 */
 ...
 *
 * @example
 * // messages 配列末尾にキャッシュブレークポイントを設定
 * const messagesWithCache = addCacheControlToLast(messages);
 */
...
export type { CacheControlEphemeral, TextBlockParam, ToolUnion, MessageParam };
